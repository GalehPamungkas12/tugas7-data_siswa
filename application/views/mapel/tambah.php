                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            //Open Form
                            echo form_open_multipart(base_url('mapel/tambah'),$atribut);
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Mata Pelajaran</label>

                                    <div class="col-sm-10"><input type="text" name="nama_mapel" class="form-control" value="<?= set_value('nama_mapel') ?>" required></div>
                                </div>
                                
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">KKM</label>

                                    <div class="col-sm-10"><input type="text" name="kkm" class="form-control"  required></div>
                                </div>
