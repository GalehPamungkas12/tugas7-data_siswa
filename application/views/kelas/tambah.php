                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            //Open Form
                            // var_dump($pegawai);
                            echo form_open_multipart(base_url('kelas/tambah'),$atribut);
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Kelas</label>

                                    <div class="col-sm-10"><input type="text" name="kelas" class="form-control" value="<?= set_value('kelas') ?>" required></div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                        <select class="form-control m-b" name="nip">
                                            ...
                                            <?php foreach ($guru as $sm) : 
                                                ...
                                                <option value="<?=$user['nip']?>"><?=$user['nama_pegawai'];?></option>
                                             <?php endforeach;?>
                                        </select>
