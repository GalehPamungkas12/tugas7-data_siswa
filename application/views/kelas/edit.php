                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            //Open Form
                            echo form_open_multipart(base_url('kelas/edit/'.$kelas->id_kelas),$atribut);
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Kelas</label>

                                    <div class="col-sm-10"><input type="text" name="kelas" class="form-control" value="<?= $kelas->kelas ?>" required></div>
                                </div>

                                <div class="form-group"><label class="col-sm-2 control-label">Wali Kelas</label>

                                <div class="col-sm-10">
                                        <select class="form-control m-b" name="nip">
                                            <option>--Pilih Guru--</option>
                                            <?php foreach ($guru as $sm) : 
                                                $user = $this->db->get_where('pegawai', ['nip' => $sm->username])->row_array();?>
                                                <option value="<?=$user['nip']?>" <?php if($kelas->nip==$user['nip']){echo "selected";}?>><?=$user['nama_pegawai'];?></option>
                                             <?php endforeach;?>
                                        </select>
